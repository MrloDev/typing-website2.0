...
function App() {
    ...
    const updateCount = (event) => {
        ...
        if (isNaN(wordAmount) || wordAmount > 250 || wordAmount === 0) { 
            document.getElementById('displayWords').innerHTML =
                `The word Amount should be a number higher than 0, equal to or less than 250`;
            return; 
        }
    ...
    const generate = (wordAmount) => { 
        ...
        for (let i = 0; i < wordAmount; i++) { 
            ...
            document.getElementById('displayWords').innerHTML += 
            `<span id="${i}" style="display: inline-block; margin-right: 5px" />`;
